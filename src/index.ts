...
function trouverjour(jour : number, mois : number, annee : number) {
    const joursemaine = [
...
function trouverPlusGrand (entier1: number, entier2 : number, entier3: number) : number{
...
const plusGrand: number = trouverPlusGrand(entier1, entier2, entier3);
